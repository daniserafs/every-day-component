...
export default {
  ...
  args: {
    urlImage:
      "https://static.vecteezy.com/ti/vetor-gratis/p1/192737-america-desert-landscape-vector-gratis-vetor.jpg",
...
export const Default: ComponentStory<typeof BannerWithText> = (args) => (
  <BannerWithText {...args} />
);
